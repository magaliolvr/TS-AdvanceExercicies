...
import { validateTask, createTask } from '../../utils/helpers';
import { 
  TASK_PRIORITIES, 
  TASK_STATUSES, 
  PRIORITY_LABELS, 
            ...
            <div className="form-group">
              ...
              <div className="tag-input-wrapper">
                ...
                <input
                  ...
                  maxLength={VALIDATION_RULES.TAG_MAX_LENGTH}
                />
                <button
                  type="button"
                  className="btn btn-secondary"
                  onClick={handleAddTag}
                  disabled={!tagInput.trim() || tags.length >= VALIDATION_RULES.MAX_TAGS}
                >
                  Add
                </button>
              </div>
              <p className="form-help">
                Press Enter to add a tag. Maximum {VALIDATION_RULES.MAX_TAGS} tags allowed.
              </p>
            </div>
